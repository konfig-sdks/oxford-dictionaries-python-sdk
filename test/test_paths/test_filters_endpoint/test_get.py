...
from oxford_dictionaries_python_sdk.paths.filters_endpoint import get
from oxford_dictionaries_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestFiltersEndpoint(ApiTestMixin, unittest.TestCase):
    """
    FiltersEndpoint unit test stubs
