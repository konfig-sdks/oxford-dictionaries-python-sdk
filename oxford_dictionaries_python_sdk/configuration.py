...
from oxford_dictionaries_python_sdk.exceptions_base import ApiValueError
from oxford_dictionaries_python_sdk.exceptions import ClientConfigurationError
from oxford_dictionaries_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = oxford_dictionaries_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://od-api-demo.oxforddictionaries.com:443/api/v1" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if app_id:
            self.api_key['appId'] = app_id
        else:
            raise ClientConfigurationError('API Key "appId" is required')
        if app_key:
            self.api_key['appKey'] = app_key
        else:
            raise ClientConfigurationError('API Key "appKey" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("oxford_dictionaries_python_sdk")
