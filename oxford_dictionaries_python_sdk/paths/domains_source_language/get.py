...
class BaseApi(api_client.Api):
    ...
    def _list_monolingual_domains_mapped_args(
        self,
        source_language: str,
    ...
    async def _alist_monolingual_domains_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/domains/{source_language}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_monolingual_domains_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListMonolingualDomainsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_monolingual_domains(
        self,
        source_language: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_monolingual_domains_mapped_args(
            source_language=source_language,
        )
        return await self._alist_monolingual_domains_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_monolingual_domains(
        self,
        source_language: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_monolingual_domains_oapg(
            path_params=args.path,
        )

class ListMonolingualDomains(BaseApi):
    ...
    async def alist_monolingual_domains(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_monolingual_domains(
            source_language=source_language,
            **kwargs,
        )
        if validate:
    ...
    def list_monolingual_domains(
        ...
        raw_response = self.raw.list_monolingual_domains(
            source_language=source_language,
        )
        if validate:
            return UtilityLabelsPydantic(**raw_response.body)
