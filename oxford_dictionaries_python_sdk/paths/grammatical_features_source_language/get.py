...
class BaseApi(api_client.Api):
    ...
    def _get_grammatical_features_mapped_args(
        self,
        source_language: str,
    ...
    async def _aget_grammatical_features_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/grammaticalFeatures/{source_language}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_grammatical_features_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetGrammaticalFeaturesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_grammatical_features(
        self,
        source_language: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_grammatical_features_mapped_args(
            source_language=source_language,
        )
        return await self._aget_grammatical_features_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_grammatical_features(
        self,
        source_language: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_grammatical_features_oapg(
            path_params=args.path,
        )

class GetGrammaticalFeatures(BaseApi):
    ...
    async def aget_grammatical_features(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_grammatical_features(
            source_language=source_language,
            **kwargs,
        )
        if validate:
    ...
    def get_grammatical_features(
        ...
        raw_response = self.raw.get_grammatical_features(
            source_language=source_language,
        )
        if validate:
            return UtilityLabelsPydantic(**raw_response.body)
