...
class RequiredExamplesListItem(TypedDict):
    text: str

class OptionalExamplesListItem(TypedDict, total=False):
...
class ExamplesListItem(RequiredExamplesListItem, OptionalExamplesListItem):
    pass
