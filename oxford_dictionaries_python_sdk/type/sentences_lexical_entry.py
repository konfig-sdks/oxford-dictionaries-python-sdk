...
class RequiredSentencesLexicalEntry(TypedDict):
    # IANA language code
    language: str
...
class OptionalSentencesLexicalEntry(TypedDict, total=False):
...
class SentencesLexicalEntry(RequiredSentencesLexicalEntry, OptionalSentencesLexicalEntry):
    pass
