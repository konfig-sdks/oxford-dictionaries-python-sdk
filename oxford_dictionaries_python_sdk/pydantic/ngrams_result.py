...
from oxford_dictionaries_python_sdk.pydantic.ngrams_result_results import NgramsResultResults
...
class NgramsResult(BaseModel):
    ...
    results: typing.Optional[NgramsResultResults] = Field(None, alias='results')
