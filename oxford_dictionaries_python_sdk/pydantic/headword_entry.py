...
from oxford_dictionaries_python_sdk.pydantic.lexical_entry import LexicalEntry
from oxford_dictionaries_python_sdk.pydantic.pronunciations_list import PronunciationsList

class HeadwordEntry(BaseModel):
    ...
    lexical_entries: typing.List[LexicalEntry] = Field(alias='lexicalEntries')
