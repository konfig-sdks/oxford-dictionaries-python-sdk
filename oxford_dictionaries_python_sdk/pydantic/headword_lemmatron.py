...
from oxford_dictionaries_python_sdk.pydantic.lemmatron_lexical_entry import LemmatronLexicalEntry

class HeadwordLemmatron(BaseModel):
    ...
    lexical_entries: typing.List[LemmatronLexicalEntry] = Field(alias='lexicalEntries')
