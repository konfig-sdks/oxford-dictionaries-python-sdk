...
from oxford_dictionaries_python_sdk.pydantic.sentences_entry import SentencesEntry

class SentencesResults(BaseModel):
    ...
    results: typing.Optional[typing.List[SentencesEntry]] = Field(None, alias='results')
