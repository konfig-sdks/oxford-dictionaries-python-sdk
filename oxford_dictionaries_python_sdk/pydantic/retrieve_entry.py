...
from oxford_dictionaries_python_sdk.pydantic.headword_entry import HeadwordEntry

class RetrieveEntry(BaseModel):
    ...
    results: typing.Optional[typing.List[HeadwordEntry]] = Field(None, alias='results')
