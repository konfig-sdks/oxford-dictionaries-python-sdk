...
from oxford_dictionaries_python_sdk.pydantic.headword_lemmatron import HeadwordLemmatron

class Lemmatron(BaseModel):
    ...
    results: typing.Optional[typing.List[HeadwordLemmatron]] = Field(None, alias='results')
