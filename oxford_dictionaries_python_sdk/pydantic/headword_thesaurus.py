...
from oxford_dictionaries_python_sdk.pydantic.thesaurus_lexical_entry import ThesaurusLexicalEntry

class HeadwordThesaurus(BaseModel):
    ...
    lexical_entries: typing.List[ThesaurusLexicalEntry] = Field(alias='lexicalEntries')
