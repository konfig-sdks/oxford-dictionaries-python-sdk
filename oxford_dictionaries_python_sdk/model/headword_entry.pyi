...
class HeadwordEntry(
        ...
        class properties:
            ...
            class lexicalEntries(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['LexicalEntry']:
                        return LexicalEntry
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['LexicalEntry'], typing.List['LexicalEntry']],
                ...
                def __getitem__(self, i: int) -> 'LexicalEntry':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "language", "lexicalEntries", "word", "pronunciations", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "language", "lexicalEntries", "word", "pronunciations", "type", ], str]):
