        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def additional_properties() -> typing.Type['Arrayofstrings']:
                        return Arrayofstrings
                
                def __getitem__(self, name: typing.Union[str, ]) -> 'Arrayofstrings':
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                def get_item_oapg(self, name: typing.Union[str, ]) -> 'Arrayofstrings':
