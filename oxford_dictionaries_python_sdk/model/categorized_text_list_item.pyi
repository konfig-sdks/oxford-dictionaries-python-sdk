...
class CategorizedTextListItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "type", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "type", "id", ], str]):
